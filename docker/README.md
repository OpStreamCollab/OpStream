...
[![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/jvera71/OpStream/blob/master/LICENSE)

Ready-to-run server image for **[OpStream](https://github.com/jvera71/OpStream)** — a real-time
...
- [Examples](#examples)
  - [1. Minimal: memory + SignalR (prototyping)](#1-minimal-memory--signalr-prototyping)
  - [2. Single node with PostgreSQL](#2-single-node-with-postgresql)
  - [3. Production cluster: 3 nodes + Postgres + Redis backplane](#3-production-cluster-3-nodes--postgres--redis-backplane)
  - [4. SQLite with persistent volume](#4-sqlite-with-persistent-volume)
  - [5. MongoDB storage](#5-mongodb-storage)
  - [6. All transports enabled (SignalR + WebSockets + gRPC)](#6-all-transports-enabled-signalr--websockets--grpc)
  - [7. TLS termination with Traefik](#7-tls-termination-with-traefik)
- [Choosing a storage backend](#choosing-a-storage-backend)
- [Choosing a backplane](#choosing-a-backplane)
- [Notes on gRPC](#notes-on-grpc)
...
```bash
git clone https://github.com/jvera71/OpStream.git
cd OpStream
...
- **GitHub:** https://github.com/jvera71/OpStream
- **Issues / bug reports:** https://github.com/jvera71/OpStream/issues
- **License:** MIT
